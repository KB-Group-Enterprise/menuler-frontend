...
import CustomerSelectMenuPage from '../pages/CustomerSelectMenuPage.vue';
import BusinessEditInformationPage from '../pages/BusinessEditInformationPage.vue';
import BusinessEditMenuPage from '../pages/BusinessEditMenuPage.vue';
import BusinessEditTableQRPage from '../pages/BusinessEditTableQRPage.vue';
import BusinessLoginPage from '../pages/BusinessLoginPage.vue';
...
const routes = [
  ...
  { name: 'CustomerSelectMenuPage', path: '/customer/menu', component: CustomerSelectMenuPage },
